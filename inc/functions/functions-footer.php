<?php function infowazz_footer_1() {?>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 footer-about">
              <h2><?php echo esc_html__('About Us', 'infowazz'); ?></h2>
              <p><?php echo html_entity_decode(get_theme_mod('infowazz_footer_about_us', 'Donec eu tellus convallis, vehicula neque sed, mattis elit. Praesent ornare, ligula in efficitur egestas, massa lacus vulputate enim')); ?> </p>
              <p><?php echo esc_html__('Contact us:', 'infowazz'); ?> <a class="mail" href="mailto:<?php echo esc_html(get_theme_mod('infowazz_footer_about_us_mail', 'info@infowazz.com')); ?>" target="_top"><?php echo esc_html(get_theme_mod('infowazz_footer_about_us_mail', 'info@infowazz.com')); ?></a></p>
            </div>
            <div class="col-md-5 footer-social">
              <h2><?php echo esc_html__('Follow Us', 'infowazz'); ?></h2>
              <?php infowazz_socials(); ?>
              <p><?php echo html_entity_decode(get_theme_mod('infowazz_footer_follow_us', 'Donec eu tellus convallis, vehicula neque sed')); ?></p>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 footer-copyright">
              <p><?php echo html_entity_decode(get_theme_mod('infowazz_copyright_text', 'Copyright 2016. Powered by WordPress Theme. By Madars Bitenieks')); ?></p>
            </div>
              <div class="col-md-6">
  ...
  <?php } ?>
  <?php
} add_filter('infowazz_footer_1','infowazz_footer_1'); ?>
<?php function infowazz_footer_2() {?>
  <?php $option = get_option("infowazz_theme_options"); ?>
  <?php if  (!empty($option['footer_top'])) {  ?>
    <?php if  ($option['footer_top'] == '1') {  ?>
      <div class="footer-top">
  ...
  <?php } ?>
  <?php
} add_filter('infowazz_footer_2','infowazz_footer_2');
function infowazz_footer_3() {?>
  <?php $option = get_option("infowazz_theme_options"); ?>
  <?php if  (!empty($option['footer_top'])) {  ?>
    <?php if  ($option['footer_top'] == '1') {  ?>
      <div class="footer-top">
  ...
  <?php } ?>
  <?php
} add_filter('infowazz_footer_3','infowazz_footer_3'); ?>
