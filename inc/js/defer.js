...
var facebook = jQuery( ".mt-f-data" ).data( "facebook" );
var twitter = jQuery( ".mt-f-data" ).data( "twitter" );
var youtube = jQuery( ".mt-f-data" ).data( "youtube" );
var token = jQuery( ".mt-f-data" ).data( "token" );
